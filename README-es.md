...
- Colecté los datos de la página [Sofascore](https://www.sofascore.com/pt/), una fuente para estatísticas deportivas. En seguida, organizé esos datos en una tabla de Excel para poder manipularlos y prepararlos para la visualización en Tableau.
